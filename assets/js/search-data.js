...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
      ...
      },{id: "news-i-will-be-participating-at-ic-s-conference-in-norrköping-sweden-from-the-21-to-the-24-july-2025-presenting-a-poster-to-the-preprint-digital-doppelgangers-or-deceptive-echoes-quantifying-human-like-response-bias-and-robustness-in-llm-generated-synthetic-survey-responses",
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/linkedin.com/in/jens-rupprecht-4018b5231", "_blank");
        },
      },{
        id: 'social-orcid',
        title: 'ORCID',
